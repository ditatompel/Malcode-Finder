#!/usr/bin/python
""" MalcodeFinder 1.2 < ditatompel [at] gmail [dot] com >
Searches for file contains dangerous commands.
...
def halo():
	...
	print "\tGreetz to all members of devilzc0de.org, ex darkc0de.com,"
	print "\tall Indonesian c0ders, and all GNU Generation ;-)\n" + "-+-"*23+"\n"
...
love = open(filelog, "w")
love.write("-+-"*23 + "\n\tMalcodeFinder 1.2 < ditatompel [at] gmail [dot] com >\n")
love.write("\tGreetz for all members of devilzc0de.org, ex darkc0de.com,\n\tall Indonesian c0ders, and all GNU Generation ;-)\n"+"-+-"*23+"\n")
